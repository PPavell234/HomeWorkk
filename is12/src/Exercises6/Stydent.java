...
public class Stydent {
    ...
    public Stydent(String studentId, String name, String surname, int yearOfStudy, double mathGrade, double economicsGrade, double foreignLanguageGrade) {this.studentId = studentId;
        this.name = name;
